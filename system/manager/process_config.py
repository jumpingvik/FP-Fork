...
procs = [
  ...
  NativeProcess("dmonitoringmodeld", "selfdrive/modeld", ["./dmonitoringmodeld"], logging, enabled=(WEBCAM or not PC)),
  ...
  PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", logging, enabled=(WEBCAM or not PC)),
