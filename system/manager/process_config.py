...
procs = [
  ...
  PythonProcess("dmonitoringmodeld", "selfdrive.modeld.dmonitoringmodeld", allow_logging, enabled=(not PC or WEBCAM)),
  ...
  PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", allow_logging, enabled=(not PC or WEBCAM)),
