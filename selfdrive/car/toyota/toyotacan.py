...
def create_accel_command(packer, accel, accel_raw, pcm_cancel, standstill_req, lead, acc_type, fcw_alert, reverse_acc, gac_send):  # TODO: find the exact canceling bit that does not create a chime
  values = {
