...
procs = [
  ...
  NativeProcess("logcatd", "system/logcatd", ["./logcatd"], logging),
  NativeProcess("proclogd", "system/proclogd", ["./proclogd"], logging),
  PythonProcess("logmessaged", "system.logmessaged", logging),
  PythonProcess("micd", "system.micd", iscar),
  PythonProcess("timed", "system.timed", always_run, enabled=not PC),

  PythonProcess("dmonitoringmodeld", "selfdrive.modeld.dmonitoringmodeld", logging, enabled=(not PC or WEBCAM)),
  ...
  PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", logging, enabled=(not PC or WEBCAM)),
